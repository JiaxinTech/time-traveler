...
const budgetRows = [
  ["住宿", "¥24,000 - ¥42,000", "3 晚商务酒店或设计型民宿，按京都站、四条河原町、乌丸御池周边单人分摊估算。"],
  ["早餐", "¥1,800 - ¥3,600", "便利店、咖啡店或酒店简餐，约 ¥600 - ¥1,200 / 天。"],
  ["午餐", "¥3,000 - ¥6,000", "拉面、荞麦面、豆腐定食、亲子丼等，约 ¥1,000 - ¥2,000 / 餐。"],
  ["晚餐", "¥6,000 - ¥12,000", "居酒屋、鳗鱼饭、京料理简餐或先斗町普通餐厅，约 ¥2,000 - ¥4,000 / 餐。"],
  ["茶点与小吃", "¥1,800 - ¥4,500", "抹茶甜品、团子、咖啡、便利店饮料和路上补给。"],
  ["市内交通", "¥2,500 - ¥4,500", "JR、地铁、阪急、京阪、巴士和少量打车补差；跨区优先轨道交通。"],
  ["门票参拜", "¥2,000 - ¥4,500", "清水寺、天龙寺庭园、二条城、寺院庭园等常规门票。"],
  ["体验预约", "¥2,000 - ¥8,000", "和服租赁、茶道、篩月精进料理加价或川床座位等可选项目。"],
  ["伴手礼与应急", "¥3,000 - ¥8,000", "药妆、小包装点心、御守、寄存柜、雨具或临时加餐。"],
  ["总计", "约 ¥46,100 - ¥93,100 / 人", "偏省钱可压到 ¥45,000 左右；旺季住宿、川床料理或高端体验会明显上浮。"]
];
    ...
    <section id="budget">
      ...
      <div className="budget">
        <table aria-label="京都三日人均预算">
          <tbody>
            {budgetRows.map(([label, value, detail]) => (
              <tr key={label}>
                <th>{label}</th>
                <td>
                  <strong>{value}</strong>
